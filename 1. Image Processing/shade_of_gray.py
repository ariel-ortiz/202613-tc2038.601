...
def grayify(input_path: str,
    ...
    out_stream1: list[int] = []  # Pixel values from 0 to 255
    out_stream2: list[int] = []  # Pixel values from 0 to 255
    red: int
    green: int
    blue: int
    ...
    out_img1.save(output_path1)
    out_img2: Image.Image = Image.new('L', size)
    out_img2.putdata(out_stream2)
    out_img2.save(output_path2)


if __name__ == '__main__':
    grayify('images/snake.png',
            'images/snake_grayscale_average.png',
            'images/snake_grayscale_luma.png')
    print('Done!')
