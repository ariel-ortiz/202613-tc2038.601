...
This project contains all the source files that the course instructor will be writing in class during the 2026 August-December semester.
...
2. Clone this repository. Type at the terminal:
    ...
    git clone https://github.com/ariel-ortiz/202613-tc2038.601.git tc2038
